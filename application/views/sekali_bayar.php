   ...
   <div class="row">
      <div class="col-md-12">
         <div class="single-table text-center mb-4 mb-md-0">
            <div class="table-top">
               <h3>Kreasi Fleksi Sekali bayar</h3>
               <i class="fa fa-money"></i>
            </div>
            <ul class="my-5" style="padding:30px;">
               <?php echo form_open('SekaliBayar/detail'); ?>
               <li class="mb-2">
                  <div class="mt-10">
               ...
               <div class="mb-5">
                   <div class="row">
                       <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6" style="margin-top:15px">
                            <a  onclick="getAngsuran()" style="color:white;background-color:#cc9933;border-color: #cc9933;" class="btn btn-lg btn-info btn-block">Hitung Pengembalian</a>
                       </div>
...
<script>
    function getTenor()
    {
        ...
        var html = "";
            ...
            var html = "<div class='icon'></div><div class='form-select' id='tenor_id'><select name='tenor_pinjaman' id='tenor_input' class='form-control' required='required' ><option value='3'>03 Bulan</option><option value='4'>04 Bulan</option><option value='6'>06 Bulan</option></select>";
    ...
    function getAngsuran(){
        ...
        $.ajax({
            type: "POST",
            url: 'https://api.thegadeareamalang.com/simulasikreasi/index.php/FleksiSekaliBayar',
            data: {up:pin, tenor:tenor},
            dataType: 'json',
            success : function(response){
                document.getElementById("angsuranShow").innerHTML ="<h2> Rp "+new Intl.NumberFormat().format(response.angsuran)+"</h1>"
            },

                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input class="form-control" type="number" step="0.001" id="biaya_admin" name="biaya_admin" placeholder="Biaya Administrasi" value="<?php echo $administrasi[0]->biaya_admin ?>">
                                <div class="input-group-addon">
                                        <span>%</span>
                                </div>
                                </div>
